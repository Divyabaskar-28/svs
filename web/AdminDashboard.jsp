...
<%
    ...
    double todayReturnAmount = 0;   // 🔥 Added
    ...
    try {
        ...
        // 🔹 Today Bill Amount (MySQL + PostgreSQL)
        ...
        // 🔹 Today Return Amount  🔥 NEW
        ps = con.prepareStatement(
            "SELECT COALESCE(SUM(return_amount),0) FROM bills WHERE DATE(return_time)=CURRENT_DATE"
        );
        rs = ps.executeQuery();
        if (rs.next()) {
