...
<%
    ...
    try {
        ...
        String billQuery = isMySQL
                ? "SELECT COALESCE(SUM(days_amount),0) FROM bills WHERE DATE(created_at)=CURRENT_DATE()"
                : "SELECT COALESCE(SUM(days_amount),0) FROM bills WHERE created_at::date = CURRENT_DATE";
